(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root['Autosuggest'] = factory(root['React']);
  ...
  return /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        /* WEBPACK VAR INJECTION */ (function(process) {
          ...
          var _arrays = __webpack_require__(10);

          var _arrays2 = _interopRequireDefault(_arrays);

          var _reactAutowhatever = __webpack_require__(11);
          ...
          var Autosuggest = (function(_Component) {
            ...
            function Autosuggest(_ref2) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (
                  Autosuggest.__proto__ || Object.getPrototypeOf(Autosuggest)
                ).call(this)
              );
            ...
            _createClass(Autosuggest, [
              ...
              },
              {
                ...
                value: function componentDidUpdate(prevProps, prevState) {
                  ...
                  if (onSuggestionHighlighted) {
                    ...
                    var prevHighlightedSuggestion =
                      prevState.highlightedSuggestion;
                ...
                value: function getHighlightedSuggestion() {
                  var _state = this.state,
                    ...
                    highlightedSuggestionIndex =
                      _state.highlightedSuggestionIndex;
              ...
              },
              {
                ...
                value: function getSuggestionIndices(suggestionElement) {
                  var sectionIndex = suggestionElement.getAttribute(
                    'data-section-index'
                  );
                ...
                value: function render() {
                  ...
                  var _props3 = this.props,
                    ...
                    onSuggestionsFetchRequested =
                      _props3.onSuggestionsFetchRequested,
          ...
          var _initialiseProps = function _initialiseProps() {
            ...
            this.highlightFirstSuggestion = function() {
              _this4.updateHighlightedSuggestion(
                _this4.props.multiSection ? 0 : null,
                0
              );
            };
            ...
            this.onSuggestionsClearRequested = function() {
              var onSuggestionsClearRequested =
                _this4.props.onSuggestionsClearRequested;
            ...
            this.onSuggestionSelected = function(event, data) {
              var _props4 = _this4.props,
                ...
                onSuggestionsFetchRequested =
                  _props4.onSuggestionsFetchRequested;
            ...
            this.onSuggestionClick = function(event) {
              var _props5 = _this4.props,
                ...
                focusInputOnSuggestionClick =
                  _props5.focusInputOnSuggestionClick;

              var _getSuggestionIndices = _this4.getSuggestionIndices(
                  _this4.findSuggestionElement(event.target)
                ),
                sectionIndex = _getSuggestionIndices.sectionIndex,
                suggestionIndex = _getSuggestionIndices.suggestionIndex;

              var clickedSuggestion = _this4.getSuggestion(
                sectionIndex,
                suggestionIndex
              );
              var clickedSuggestionValue = _this4.props.getSuggestionValue(
                clickedSuggestion
              );
            ...
            this.renderSuggestionsContainer = function(_ref5) {
              ...
              var renderSuggestionsContainer =
                _this4.props.renderSuggestionsContainer;
	...
	*/
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var _sectionIterator = __webpack_require__(13);

        var _sectionIterator2 = _interopRequireDefault(_sectionIterator);

        var _reactThemeable = __webpack_require__(14);

        var _reactThemeable2 = _interopRequireDefault(_reactThemeable);

        var _SectionTitle = __webpack_require__(16);

        var _SectionTitle2 = _interopRequireDefault(_SectionTitle);

        var _ItemsList = __webpack_require__(18);
        ...
        var emptyObject = {};
        var defaultRenderInputComponent = function defaultRenderInputComponent(
          props
        ) {
          return _react2.default.createElement('input', props);
        };
        var defaultRenderItemsContainer = function defaultRenderItemsContainer(
          _ref
        ) {
          var containerProps = _ref.containerProps,
            children = _ref.children;
        ...
        var Autowhatever = (function(_Component) {
          ...
          function Autowhatever(props) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (
                Autowhatever.__proto__ || Object.getPrototypeOf(Autowhatever)
              ).call(this, props)
            );
            ...
            _this.getItemId = function(sectionIndex, itemIndex) {
              ...
              var section =
                sectionIndex === null ? '' : 'section-' + sectionIndex;
              ...
              switch (event.key) {
                ...
                case 'ArrowUp': {
                  ...
                  var _this$sectionIterator = _this.sectionIterator[nextPrev]([
                    ...
                    _this$sectionIterator2 = _slicedToArray(
                      _this$sectionIterator,
                      2
                    ),
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        exports['default'] = function(input) {
          var _ref =
            Array.isArray(input) && input.length === 2 ? input : [input, null];
          ...
          return function(key) {
            ...
            return typeof styles[0] === 'string' ||
              typeof classNameDecorator === 'function'
              ? {
                  key: key,
                  className: classNameDecorator
                    ? classNameDecorator.apply(
                        undefined,
                        _toConsumableArray(styles)
                      )
                    : styles.join(' ')
                }
              : {
                  key: key,
                  style: _objectAssign2['default'].apply(
                    undefined,
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var _compareObjects = __webpack_require__(17);
        ...
        var SectionTitle = (function(_Component) {
          ...
          function SectionTitle() {
            ...
            return _possibleConstructorReturn(
              this,
              (
                SectionTitle.__proto__ || Object.getPrototypeOf(SectionTitle)
          ...
          function ItemsList() {
            ...
            return (
              (_ret = ((_temp = ((_this = _possibleConstructorReturn(
                ...
                (_ref =
                  ItemsList.__proto__ ||
                  Object.getPrototypeOf(ItemsList)).call.apply(
                  _ref,
                  [this].concat(args)
                )
              )),
          ...
          function Item() {
            ...
            return (
              (_ret = ((_temp = ((_this = _possibleConstructorReturn(
                this,
                (_ref =
                  Item.__proto__ || Object.getPrototypeOf(Item)).call.apply(
                  _ref,
                  [this].concat(args)
                )
              )),
              _this)),
              (_this.storeItemReference = function(item) {
                if (item !== null) {
                  _this.item = item;
                }
              }),
          ...
          _createClass(Item, [
            ...
            },
            {
              ...
              value: function render() {
                ...
                return _react2.default.createElement(
                  'li',
                  _extends({ role: 'option' }, restProps, {
                    ref: this.storeItemReference
                  }),
                  renderItem(
                    item,
                    _extends({ isHighlighted: isHighlighted }, renderItemData)
                  )
                );
              }
            }
