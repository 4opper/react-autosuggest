  ...
  return (function(e) {
            ...
            a(t, [
              ...
              },
              {
                ...
                value: function(e, t) {
                  ...
                  if (!(0, f.default)(o, e.suggestions) && o.length > 0 && r)
                    return void this.highlightFirstSuggestion();
                  if (i) {
                    var u = this.getHighlightedSuggestion(),
                      s = t.highlightedSuggestion;
                    u != s && i({ suggestion: u });
                  }
                }
              },
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  throw (console.error('Clicked element:', e),
              ...
              },
              {
                ...
                value: function() {
                  var e = this,
                    ...
                    b = I.isFocused,
                    w = I.isCollapsed,
                    _ = I.highlightedSectionIndex,
                    x = I.highlightedSuggestionIndex,
                    O = I.valueBeforeUpDown,
                    C = y ? v : this.props.shouldRenderSuggestions,
                    j = u.value,
                    P = u.onFocus,
                    k = u.onKeyDown,
                      ...
                      onKeyDown: function(t, o) {
                        ...
                        switch (r) {
                          ...
                          case 13:
                            ...
                            if ((E && !y && e.closeSuggestions(), null != l)) {
                              var c = h(l);
                            ...
                            if (null === O) {
                              if (!g) {
                                ...
                                e.maybeCallOnChange(t, d, 'escape'),
                                  C(d)
                                    ? i({ value: d, reason: 'escape-pressed' })
                                    : e.onSuggestionsClearRequested();
                              }
                  ...
                  return c.default.createElement(p.default, {
                    ...
                    theme: (0, m.mapToAutowhateverTheme)(f),
                    id: g,
        ...
        (this.onDocumentMouseDown = function(t) {
          ...
          (this.renderSuggestionsContainer = function(t) {
            var n = t.containerProps,
              o = t.children,
              i = e.props.renderSuggestionsContainer;
            return i({ containerProps: n, children: o, query: e.getQuery() });
          });
      };
    ...
    function(e, t, n) {
      ...
      var s =
        ...
        w = {},
        _ = function(e) {
          return g.default.createElement('input', e);
        },
        x = function(e) {
          var t = e.containerProps,
            n = e.children;
          return g.default.createElement('div', t, n);
        },
        O = {
          ...
          function t(e) {
            ...
            return (
              ...
              (n.getItemId = function(e, t) {
                ...
                var o = n.props.id,
                  i = null === e ? '' : 'section-' + e;
                return 'react-autowhatever-' + o + '-' + i + '-item-' + t;
              }),
              ...
              (n.onKeyDown = function(e) {
                var t = n.props,
                  ...
                  r = t.highlightedItemIndex;
                switch (e.key) {
                  case 'ArrowDown':
                  case 'ArrowUp':
                    var u = 'ArrowDown' === e.key ? 'next' : 'prev',
                      s = n.sectionIterator[u]([i, r]),
                      l = a(s, 2),
                      c = l[0],
                      g = l[1];
                    o.onKeyDown(e, {
          ...
          return (
            ...
            l(t, [
              ...
              },
              {
                ...
                value: function(e) {
                  this.sectionIterator = (0, p.default)({
              ...
              },
              {
                ...
                value: function() {
                  ...
                  return g.default.createElement(b.default, {
                    ...
                    renderItem: i,
                    renderItemData: r,
                    highlightedItemIndex: null === u ? s : null,
              ...
              },
              {
                ...
                value: function() {
                  var e = this.theme,
                    ...
                    c = o ? this.renderSections() : this.renderItems(),
                    d = null !== c,
                    f = this.getItemId(u, a),
                  ...
                  return g.default.createElement('div', p, m, v);
                }
              }
            ]),
            t
    ...
    function(e, t) {
      ...
      e.exports = function(e) {
        ...
        function r(e) {
          ...
          return a
            ? null === r || 0 === r
              ? ((i = o(i)), null === i ? [null, null] : [i, s[i] - 1])
              : [i, r - 1]
            : 0 === s || 0 === r
              ? [null, null]
              : null === r
    ...
    function(e, t) {
      ...
      e.exports =
        Object.assign ||
        function(e, t) {
          for (var i, r, u = n(e), s = 1; s < arguments.length; s++) {
            (i = arguments[s]), (r = o(Object(i)));
            for (var a = 0; a < r.length; a++) u[r[a]] = i[r[a]];
          }
          return u;
        };
    },
    function(e, t, n) {
      ...
      (h.propTypes = {
        section: g.default.any.isRequired,
        renderSectionTitle: g.default.func.isRequired,
        theme: g.default.func.isRequired,
        sectionKeyPrefix: g.default.string.isRequired
      }),
        (t.default = h);
    },
    function(e, t) {
        ...
        for (s = 0, a = i.length; s < a; s++) {
          ...
          if (c !== g) {
            if (
              ...
              'object' !== ('undefined' == typeof g ? 'undefined' : o(g))
            )
              return !0;
            var d = Object.keys(c),
              f = Object.keys(g);
    ...
    function(e, t, n) {
            ...
            a(t, [
              {
                key: 'shouldComponentUpdate',
                value: function(e) {
                  return (0, m.default)(e, this.props, ['itemProps']);
                }
              },
              {
                key: 'render',
                value: function() {
                  var e = this,
                    ...
                    g = t.theme,
                    d = t.keyPrefix,
                    f = null === u ? d : d + 'section-' + u + '-',
                    p = 'function' == typeof o;
                  return c.default.createElement(
                    'ul',
                    s({ role: 'listbox' }, g(f + 'items-list', 'itemsList')),
                    n.map(function(t, n) {
                      var d = 0 === n,
                        m = n === a,
                        v = f + 'item-' + n,
                        y = p ? o({ sectionIndex: u, itemIndex: n }) : o,
                        S = s(
                          { id: l(u, n), 'aria-selected': m },
                          g(
                            v,
                            'item',
                            d && 'itemFirst',
      ...
      (v.propTypes = {
        ...
        (v.defaultProps = { sectionIndex: null }),
        (t.default = v);
    },
    function(e, t, n) {
      'use strict';
            ...
            l(t, [
              {
                key: 'shouldComponentUpdate',
                value: function(e) {
                  return (0, p.default)(e, this.props, ['renderItemData']);
                }
              },
              {
                key: 'render',
